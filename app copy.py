...
#     'Temperature': [21.975, 31.865, 28.506, 24.936, 33.683],
#     'Humidity': [54.504, 41.832, 54.468, 53.969, 51.240],
#     'Precipitation': [532.447, 642.612, 476.139, 814.424, 794.422]
# }

# data_prod = {
#     'Year': [2020, 2021, 2022, 2023, 2024],
#     'Growth_Days': [89.422, 92.711, 89.018, 100.699, 89.272],
#     'Yield': [187.962, 128.782, 169.064, 161.444, 121.693],
#     'Water_Consumption': [495.280, 349.813, 592.805, 250, 250],
#     'Fertilizer_Consumption': [100.765, 130.961, 75.615, 108.166, 105.701]
# }
...
#### Utili per analizzare i dati ambientali in modo chiaro ed interattivo, permettendo anche agli utenti non tecnici di osservare
#### le tendenze nel tempo dei vari parametri e di interagire attivamente per monitorare i cambiamenti in funzione dei parametri
#### modificati

# Creazione del grafico dei dati ambientali
# df_env è il DataFrame contenente i dati da visualizzare
...
# Creazione del grafico a barre raggruppate dei dati di produzione
# df_prod è il DataFrame contenente i dati da visualizzare
...
# Creazione dei grafici di performance (2D e 3D)
# df_perf è il DataFrame contenente i dati da visualizzare
...
#### Layout dell'applicazione, dei grafici e delle tabelle
...
### Funzioni di callback invocate dalle interazioni con grafici e tabelle (click sul pulsante)
...
# Creazione del grafico per i dati previsionali di produzione e ambientali
def create_fig_future(df_future):
    ...
    return fig
# Callback che aggiorna grafico e tabella previsionali
@app.callback(
